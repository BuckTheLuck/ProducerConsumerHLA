 ...
 */
public class LiftFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	public LiftFederateAmbassador(LiftFederate federate )
	{
	...
	public void receiveInteraction( InteractionClassHandle interactionClass,
	    ...
	    throws FederateInternalError
	{
		theParameters.get(federate.IDAddToLiftHandle);
		HLAinteger32BE skierID = new HLA1516eInteger32BE();
		try {
			skierID.decode(theParameters.get(federate.IDAddToLiftHandle));
		} catch (DecoderException e) {
			e.printStackTrace();
		}
		log( "Narciarz: "+ skierID.getValue() + " na wyciągu");
