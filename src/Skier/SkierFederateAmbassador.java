 ...
 * {@link SkierFederate}. It will log information about any callbacks it
 * receives, thus demonstrating how to deal with the provided callback information.
 */
public class SkierFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                   INSTANCE VARIABLES
	//----------------------------------------------------------
	private SkierFederate federate;
	...
	public SkierFederateAmbassador(SkierFederate federate )
	{
	...
	public void announceSynchronizationPoint( String label, byte[] tag )
	{
		...
		if( label.equals(SkierFederate.READY_TO_RUN) )
