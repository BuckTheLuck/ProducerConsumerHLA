...
public class LiftFederate
{
	...
	private LiftFederateAmbassador fedamb;  // created when we connect
	...
	protected ParameterHandle IDAddToLiftHandle;
	//----------------------------------------------------------
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	...
	public void runFederate( String federateName ) throws Exception
	{
		...
		// connect
		log( "Connecting..." );
		fedamb = new LiftFederateAmbassador( this );
...
//				ParameterHandle addProductsCountHandle = rtiamb.getParameterHandle(AddToLiftHandle, "count");
...
//		publish AddProducts Interaction
		...
		IDAddToLiftHandle = rtiamb.getParameterHandle( AddToLiftHandle, "ID" );
		// do the publication
		rtiamb.subscribeInteractionClass(AddToLiftHandle);
	...
	public static void main( String[] args )
	{
		...
		try
		{
			...
			new LiftFederate().runFederate( federateName );
		}
